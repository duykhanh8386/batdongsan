...
public class PropertyController {
    ...
    @GetMapping("/statistical-chart")
    public ModelAndView showStatisticalChart() {
        ModelAndView modelAndView = new ModelAndView("house-landforstatistical-chart");
        try {
            UserAccountDto user = userAccountService.getMyInfo();
            System.out.println("User data: " + user);
            System.out.println("Role: " + user.getRole());
        ...
        // Biểu đồ 1: Tổng giá theo ngày cho "Bán" (completed)
        modelAndView.addObject("soldCompletedDates", transactionService.getDatesByType("Bán"));
        modelAndView.addObject("soldCompletedPrices", transactionService.getTotalPricesByType("Bán"));

        // Biểu đồ 2: Tổng giá theo ngày cho "Cho thuê" (completed)
        modelAndView.addObject("rentCompletedDates", transactionService.getDatesByType("Cho thuê"));
        modelAndView.addObject("rentCompletedPrices", transactionService.getTotalPricesByType("Cho thuê"));

        // Biểu đồ 3: Số lượng giao dịch "Bán" theo trạng thái
        modelAndView.addObject("soldStatusLabels", transactionService.getStatusesByType("Bán"));
        modelAndView.addObject("soldStatusCounts", transactionService.getCountsByStatusAndType("Bán"));

        // Biểu đồ 4: Số lượng giao dịch "Cho thuê" theo trạng thái
        modelAndView.addObject("rentStatusLabels", transactionService.getStatusesByType("Cho thuê"));
        modelAndView.addObject("rentStatusCounts", transactionService.getCountsByStatusAndType("Cho thuê"));
